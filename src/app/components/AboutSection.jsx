    ...
    >
      <div className="md:grid md:grid-cols-2 gap-8 items-center pt-8 pb-3 px-4 xl:gap-16 sm:py-16 xl:px-16">
        <Image
          ...
          alt="Imagen sección acerca de mi"
          width={500}
          height={500}
        />
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            Soy un Ingeniero en Sistemas con tres años de experiencia,
            especializado en el desarrollo web en roles tanto de desarrollador
            frontend como fullstack. Aprendo rápidamente, estoy en búsqueda de
            la ampliación de mis conocimientos y habilidades. Me entusiasma
            colaborar en equipos y crear aplicaciones excepcionales.
          </p>
          <div className="mt-1">
            <Swiper
              autoplay={{
